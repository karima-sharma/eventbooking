...
const users = [
    { name: 'Admin User', email: 'admin@nexusfest.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@nexusfest.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@nexusfest.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/nexusfest');
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@nexusfest.com');
        console.log('User Email:  user@nexusfest.com');
